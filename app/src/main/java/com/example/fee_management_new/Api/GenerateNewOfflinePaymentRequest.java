...
public class GenerateNewOfflinePaymentRequest {
    ...
    public GenerateNewOfflinePaymentRequest(int amount, String note, String paymentType, String paymentMethod, String discountDetails, String additionDetails, String dueDate, ArrayList<Integer> userIds, int standardId) {
        this.amount = amount;
        this.note = note;
